  ...
  all_sales AS (
   ...
   FROM
     (
      ...
      INNER JOIN hive.tpcds_300gb_orc.date_dim ON ("d_date_sk" = "cs_sold_date_sk"))
      LEFT JOIN hive.tpcds_300gb_orc.catalog_returns ON ("cs_order_number" = "cr_order_number")
...
UNION       SELECT
      ...
      INNER JOIN hive.tpcds_300gb_orc.item ON ("i_item_sk" = "ss_item_sk"))
      INNER JOIN hive.tpcds_300gb_orc.date_dim ON ("d_date_sk" = "ss_sold_date_sk"))
      LEFT JOIN hive.tpcds_300gb_orc.store_returns ON ("ss_ticket_number" = "sr_ticket_number")
...
UNION       SELECT
      ...
      INNER JOIN hive.tpcds_300gb_orc.item ON ("i_item_sk" = "ws_item_sk"))
      INNER JOIN hive.tpcds_300gb_orc.date_dim ON ("d_date_sk" = "ws_sold_date_sk"))
      LEFT JOIN hive.tpcds_300gb_orc.web_returns ON ("ws_order_number" = "wr_order_number")
