  ...
  (
   ...
   FROM
     (
      ...
      FROM
        (hive.tpcds_300gb_orc.web_sales ws
      LEFT JOIN hive.tpcds_300gb_orc.web_returns wr ON ("ws"."ws_order_number" = "wr"."wr_order_number")
  ...
  (
   ...
   FROM
     (
      ...
      FROM
        (hive.tpcds_300gb_orc.catalog_sales cs
      LEFT JOIN hive.tpcds_300gb_orc.catalog_returns cr ON ("cs"."cs_order_number" = "cr"."cr_order_number")
...
UNION SELECT
  'hive.tpcds_300gb_orc.store' "channel"
, "store"."item"
, "store"."return_ratio"
, "store"."return_rank"
, "store"."currency_rank"
  ...
  (
   ...
   FROM
     (
      ...
      FROM
        (hive.tpcds_300gb_orc.store_sales sts
      LEFT JOIN hive.tpcds_300gb_orc.store_returns sr ON ("sts"."ss_ticket_number" = "sr"."sr_ticket_number")
